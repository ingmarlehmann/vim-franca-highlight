...
syn match       fAnnotation        "@[_$a-zA-Z][_$a-zA-Z0-9_]*\>"
syn cluster     fCommentGroup      contains=fTodo
syn region      fComment           start="/\*" end="\*/" contains=@fCommentGroup,@Spell
syn region      fComment           start="//" end="$" contains=@fCommentGroup,@Spell
syn region      fComment           start="<\*\*" end="\*\*>" contains=fAnnotation,@fCommentGroup,@Spell
...
hi def link fAnnotation PreProc
